...
def processResults():
    ...
    for e in eventLog:
        ...
        totalWait += waitTime
        totalItems += e[1] # number of items
    ...
    print("The average number of items purchased was %.2f items." % avgItems)
    print("The maximum wait time was %.2f minutes." % maxWaitTime)
    print("The total idle time was %d minutes" % idleTime)
    print("Total number of shopper was %d" % totalShoppers)
